...
### 느낀점
---
Vue 라는 프레임워크를 전체적으로 경험해 볼 수 있는 점이 좋았습니다. 최초 실행이 어떤 원리로 진행되는지, 라이프사이클 훅이 어떻게 구성 되어있는지도 알 수 있었으며

Store 의 개념도 강화 할 수 있었고 provide, inject 등 다양한 Vue 의 매력을 느낄수 있는 경험이었습니다.
